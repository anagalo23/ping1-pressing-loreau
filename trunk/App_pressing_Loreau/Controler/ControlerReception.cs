...
namespace App_pressing_Loreau.Controler
{
    class ControlerReception
    {
        public void ajoutCommande(Commande commande)
        {
            ...
            // Steps for add the command in the Database
            ...
            //Get the client id
            int idClt;
            if ((commande.client.id == null) && (commande.clientpro.id != null))
            {
                idClt = commande.clientpro.id;
            }
            else if ((commande.client.id != null) && (commande.clientpro.id == null))
            {
