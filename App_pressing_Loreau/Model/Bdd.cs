...
namespace App_pressing_Loreau.Model
{
    class Bdd
    {
        ...
        public static String selectTypeById = "SELECT T.typ_id, T.typ_nom, T.typ_encombrement, T.typ_TVA, T.typ_HT, T.typ_dep_id, D.dep_nom FROM type T, departement D WHERE T.typ_dep_id=D.dep_id AND T.typ_id=?";
        #endregion
    }
}
